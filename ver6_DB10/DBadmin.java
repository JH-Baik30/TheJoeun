...
//	dbm.insertToDB(acc,   "oneLove", "나도몰래", "한사랑", "2000-03-26");
...
//	String da = "2000-03-26";
//	System.out.println(java.sql.Date.valueOf(da));
...
/*	dbm.deleteToDB(acc);
	dbm.deleteToDB(acc+1);
	dbm.deleteToDB(acc+2);
	dbm.deleteToDB(acc+3);
	dbm.deleteToDB(acc+4);
*/
